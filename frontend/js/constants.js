const contractAddress = "0xdC2e46F4904f1DB3aCAEb0a57973e4e55F0E4b6c"; // Replace with your own contract address
const chain = 'rinkeby'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to the Lost Jockeys Test Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Lost Jockeys Test Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. Follow step by step on the <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
